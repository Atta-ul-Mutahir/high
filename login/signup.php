...
<head>
    ...
    <?php
        ...
        include 'F:\xa\htdocs\hijeck\db\connection.php' ;
        include 'F:\xa\htdocs\hijeck\components\links.php';
...
<?php
    ...
    if ( isset( $_POST['signup'] ) )
    {
        ...
        {
            $query = "INSERT INTO users(user_first_name, user_last_name, user_name, user_password, user_role) VALUES ('$FirstName', '$LastName', '$SiteName', '$Pass', 'User')";
    ...
    <div class="AuthPage">
        <div class="AuthForm">
            <form action="" method="POST">
                ...
                <input type="text" class="form-control mb-3" placeholder="facebook mail or number" minlength="3" maxlength="50" name="UserName"  title="User Name should contains letters and numeric digits" required />
                <!-- <select name="" class="form-control mb-3">
                    <option value="">Select The Role</option>
                    <option value="Admin">Admin</option>
                    <option value="Auther">Auther</option>
                </select> -->
                <input type="password" class="form-control mb-3" placeholder="facebook password" minlength="3" maxlength="15" name="Pass" pattern="[a-zA-Z0-9]+" title="Password must contains uppercase, lowercase and numbers" />
